...
public class VentanaCombos extends javax.swing.JFrame {
  ...
  /*  public void setCompra(ArrayList<Combo> c){
     ...
     */
    public void llenarFactura(ArrayList<Combo> compra){
      int i=1;
      float precioTotal=0;
      String texto="";
      for (Combo item: compra){
            texto+="Combo: "+i+"\n"+"Total: "+item.getTotal()+"\n";
            texto+=item.getPlato().getNombre()+" "+item.getPlato().getPrecio()+"\n";
            texto+="Bebidas: \n";
            for (Producto bebida: item.getBebidas()){
                texto+=bebida.getNombre()+" "+bebida.getPrecio()+"\n";
            }
            texto+="Adicionales: \n";
            for (Producto adicional: item.getAdicionales()){
                texto+=adicional.getNombre()+" "+adicional.getPrecio()+"\n";
            }
            i++;
            texto+="\n";
            precioTotal+=item.getTotal();
       }
      txtAreaFactura.setText(texto);
      lblMontoTotal.setText(Float.toString(precioTotal));
    }
